...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    public Restaurant create(CreateRestaurantRequest request, Long actorUserId) {
        ...
        restaurant.setPhoneNumber(blankToNull(request.phoneNumber()));
    ...
    private Map<String, Object> restaurantState(Restaurant restaurant) {
        ...
        state.put("description", restaurant.getDescription());
        state.put("phoneNumber", restaurant.getPhoneNumber());
