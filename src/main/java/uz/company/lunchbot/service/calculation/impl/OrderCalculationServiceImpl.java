...
public class OrderCalculationServiceImpl implements OrderCalculationService {
    ...
    private BigDecimal applyRounding(BigDecimal value) {
        RoundingStrategy strategy = resolveRoundingStrategy();
    ...
    private RoundingStrategy resolveRoundingStrategy() {
        return lunchProperties.roundingStrategy() == null
                ? RoundingStrategy.CEIL_TO_100
                : lunchProperties.roundingStrategy();
    }
